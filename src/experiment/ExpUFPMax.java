...
/**
 * Experiment class for UFPMax algorithm.
 * Reads an uncertain database, runs UFPMax, and outputs results with statistics.
 *
 * Usage:
 *   java experiment.ExpUFPMax <input_file> <minsup> [output_file]
 *
 * @author Ma Quoc Cuong, Nguyen Cao Phi
 */
public class ExpUFPMax {

    public static void main(String[] args) throws IOException {
        if (args.length < 2) {
            System.err.println("Usage: java experiment.ExpUFPMax <input_file> <minsup> [output_file]");
            return;
        }
        ...
        System.out.println("Algorithm: UFPMax");
        ...
        tracker.start();
        UFPMax algorithm = new UFPMax(db, minsup, -1);
